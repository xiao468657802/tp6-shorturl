<?php /*a:1:{s:46:"/www/wwwroot/short.com/think/view/./index.html";i:1626943761;}*/ ?>
...
<head>
  ...
  <!-- <link href="./ajax/libs/font-awesome/5.13.1/css/all.min.css" rel="stylesheet"> 本地css,经测不稳定    Nucleo Icons -->
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navigation">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item p-0">
          <a class="nav-link" rel="tooltip" title="Free API URL" data-placement="bottom" href="api/css/qawAPI.html" target="_blank">
            <i class="fa fa-heart" aria-hidden="true"></i>
        ...
        <li class="nav-item p-0">
          <a class="nav-link" rel="tooltip" title="What’s the point?" data-placement="bottom" href="api/css/qawFAQ.html" target="_blank">
            <i class="fa fa-heart" aria-hidden="true"></i>
